...
public class OakConfig {
    ...
    public static final long AUTO_REFRESH_COURSES_MILLIS = 1 * DateUtils.SECOND_IN_MILLIS;
    public static final long AUTO_REFRESH_QUESTIONS_MILLIS = 1 * DateUtils.SECOND_IN_MILLIS;
